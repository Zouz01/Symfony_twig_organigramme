...
class DefaultController extends AbstractController
{
    ...
    {
        // Récupérer le EntityManager à partir du ManagerRegistry
        $entityManager = $doctrine->getManager();

        // Recherche les subordonnés de l'équipe donnée dans la base de données
      // Appeler la fonction getSubordinates avec les arguments requis
$subordinates = $this->getSubordinates($team, $doctrine);
